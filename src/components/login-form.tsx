          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
               <h1 className="text-2xl font-bold text-[#FB8C00]">Welcome back</h1>
<p className="text-muted-foreground">Login to your account</p>
              ...
              <Button type="submit" className ="w-full bg-[#FB8C00]" disabled={loading}>
...
>
  {/* CATATAN: SVG ini akan mengikuti warna teks (menjadi oranye) karena ada "fill='currentColor'".
    Logo Google asli di gambar memiliki banyak warna, yang memerlukan SVG yang lebih kompleks.
  */}
  <svg
    className="h-5 w-5"
  ...
  <span>Login with Google</span>
          ...
          <div className=" relative hidden md:block">
            <img
              ...
              alt="Image"
              className="absolute relative z-10 max-h-full max-w-full object-contain"
            />
          </div>
        </CardContent>
      </Card>

...
import { ArrowLeft, Package, Edit, Layers } from "lucide-react"
...
export default function VarianEditPage() {
      ...
      <div className="min-h-screen bg-gradient-to-b from-orange-50/30 to-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 mb-6">
            Varian yang Anda cari tidak tersedia
          </p>
          <Button
  ...
  const varianName = varian.ukuran && varian.warna 
    ? `${varian.ukuran} - ${varian.warna}`
    : varian.ukuran || varian.warna || "Varian"
        ...
        <Card className="border-0 shadow-md rounded-2xl overflow-hidden">
          <CardHeader className="bg-gradient-to-r from-orange-50 to-white border-b">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-lg">Edit Detail Varian</CardTitle>
                <CardDescription>Perbarui informasi varian produk</CardDescription>
              </div>
            </div>
          </CardHeader>
